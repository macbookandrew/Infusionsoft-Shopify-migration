...
var config = require('./config'),
    ...
    orderDataQueryString = 'SELECT \
            ...
            ( SELECT group_concat( shopify_product_id SEPARATOR "|" ) FROM infusionsoft_products products JOIN wpora_woocommerce_order_itemmeta meta1 ON products.woocommerce_product_id = meta1.meta_value JOIN wpora_woocommerce_order_itemmeta meta2 ON products.woocommerce_variant_id = meta2.meta_value WHERE meta1.order_item_id IN ( SELECT order_item_id FROM wpora_woocommerce_order_items WHERE order_id = p.ID AND order_item_type = "line_item" ) AND meta1.meta_key = "_product_id" AND meta2.order_item_id IN ( SELECT order_item_id FROM wpora_woocommerce_order_items WHERE order_id = p.ID AND order_item_type = "line_item" ) AND meta2.meta_key = "_variation_id" ) AS line_items_ids, \
            ( SELECT group_concat( shopify_variant_id SEPARATOR "|" ) FROM infusionsoft_products products JOIN wpora_woocommerce_order_itemmeta meta1 ON products.woocommerce_product_id = meta1.meta_value JOIN wpora_woocommerce_order_itemmeta meta2 ON products.woocommerce_variant_id = meta2.meta_value WHERE meta1.order_item_id IN ( SELECT order_item_id FROM wpora_woocommerce_order_items WHERE order_id = p.ID AND order_item_type = "line_item" ) AND meta1.meta_key = "_product_id" AND meta2.order_item_id IN ( SELECT order_item_id FROM wpora_woocommerce_order_items WHERE order_id = p.ID AND order_item_type = "line_item" ) AND meta2.meta_key = "_variation_id" ) AS line_items_variant_ids, \
